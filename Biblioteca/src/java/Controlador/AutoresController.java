...
import Repositorios.AutoresFacade;
...
public class AutoresController implements Serializable {
    ...
    @EJB
    private Repositorios.AutoresFacade ejbFacade;
    private PaginationHelper pagination;
    private int selectedItemIndex;
    private List<Autores> lista = new ArrayList();
    ...
    public void setCodPais(Paises codPais) {
     ...
     public void obtener_autores_paises(){
        lista = ejbFacade.pais_autor(codPais);
    }
    ...
    public SelectItem[] getItemsAvailableSelectOne() {
        return JsfUtil.getSelectItemsName(ejbFacade.autores_ordenados(), true);
    }
