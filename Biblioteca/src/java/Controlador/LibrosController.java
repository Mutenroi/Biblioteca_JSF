...
import Repositorios.LibrosFacade;
...
public class LibrosController implements Serializable {
    ...
    @EJB
    private Repositorios.LibrosFacade ejbFacade;
    ...
    public void setLista(List<Libros> lista) {
        this.lista = lista;
    }
    ...
    public void obtener_libros_autor(){
        lista = ejbFacade.libros_autor(codAutor);
    }
    
    public void obtener_libros_autor(Autores autor){
        lista = ejbFacade.libros_autor(autor);
    }
    
    public String mostrar(Libros libro){
        if("".equals(libro.getPelicula()))
            return "none";
        else
            return "";
    }
    ...
    public SelectItem[] getItemsAvailableSelectOne() {
        return JsfUtil.getSelectItemsNameLib(ejbFacade.libros_ordenados(), true);
    }
