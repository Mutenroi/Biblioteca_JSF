...
public class AutorPremioController implements Serializable {
    ...
    public String create() {
        try {
            current.getAutorPremioPK().setCodAutor(current.getAutores().getCodAutor());
            current.getAutorPremioPK().setCodPremio(current.getPremios().getCodPremio());
    ...
    public static class AutorPremioControllerConverter implements Converter {
        ...
        Modelos.AutorPremioPK getKey(String value) {
            ...
            key.setAno(Integer.parseInt(values[2]));
            return key;
        }
